"""
Script to migrate files from old repository to new SavingsTrackerV2 repository based on file_tracking table.
...
NEW_REPO = os.path.normpath(r'\\montefiore.org\\centralfiles\\data\\Procurement PMO\\SavingsTrackerV2')
...
def clean_new_repository(repo_path, dry_run=False):
    ...
    if repo_name.lower() != "savingstrackerv2":
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Migrate or refresh file_tracking file metadata.")
